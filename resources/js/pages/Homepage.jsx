...
export default function Homepage({ isLoggedIn, user, token, onNavigateToLogin, onNavigateToRegister, onNavigateToDashboard, onNavigateToCreateAd, onNavigateToClassifieds, onLogout, darkMode, setDarkMode }) {
    ...
    const categories = [
        { name: "Template", count: "42+ Layanan", icon: LayoutGrid },
        { name: "Ebook", count: "28+ Layanan", icon: LayoutGrid },
        { name: "Software", count: "19+ Layanan", icon: LayoutGrid },
        { name: "Website", count: "35+ Layanan", icon: LayoutGrid },
        { name: "Design", count: "54+ Layanan", icon: LayoutGrid },
        { name: "Video", count: "22+ Layanan", icon: LayoutGrid },
        { name: "Audio", count: "15+ Layanan", icon: LayoutGrid },
        { name: "Course", count: "31+ Layanan", icon: LayoutGrid },
        { name: "Social Media", count: "48+ Layanan", icon: Share2, isBlueIcon: true },
        { name: "Digital Marketing", count: "39+ Layanan", icon: LayoutGrid },
        { name: "Business", count: "26+ Layanan", icon: LayoutGrid },
        { name: "Education", count: "18+ Layanan", icon: LayoutGrid },
        { name: "Tools", count: "45+ Layanan", icon: LayoutGrid },
        { name: "Jasa", count: "29+ Layanan", icon: LayoutGrid },
        { name: "Lainnya", count: "12+ Layanan", icon: LayoutGrid }
    ];
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
                        {categories.map((cat, idx) => {
                            ...
                            return (
                                <div 
                                    key={idx}
                                    className="p-6 bg-white border border-slate-400/80 hover:border-sky-500/50 hover:shadow-md rounded-2xl transition-all hover:scale-[1.03] cursor-pointer text-left flex flex-col justify-between min-h-[140px] group"
                                >
                                    ...
                                    <div className={`w-10 h-10 rounded-xl border flex items-center justify-center mb-4 ${
                                        cat.isBlueIcon 
                                            ...
                                            : 'bg-slate-50 border border-slate-200 text-slate-400 group-hover:text-slate-600 transition-colors'
                                    }`}>
                                    ...
                                    <div>
                                        <h4 className="font-extrabold text-sm text-slate-800 leading-tight mb-1">{cat.name}</h4>
                                        <span className="text-[10px] text-slate-400 font-semibold group-hover:text-sky-500 transition-colors flex items-center gap-0.5">
                                            {cat.count} &rarr;
                                        </span>
                                    </div>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {products.map((prod) => (
                            <div 
                                key={prod.id}
                                className="rounded-2xl border border-slate-200/80 bg-white overflow-hidden flex flex-col justify-between group transition-all hover:translate-y-[-4px] hover:shadow-md"
                            >
                                <div>
                                    {/* Product Image */}
                                ...
                                <div className="p-5 pt-0 border-t border-slate-100 mt-4 flex items-center justify-between">
                                    ...
                                    <button 
                                        ...
                                        className="bg-[#10B981] hover:bg-[#059669] text-white font-bold text-xs py-2 px-4 rounded-lg shadow-sm transition-colors"
                                    >
                                        Beli Sekarang
                                    </button>
                                </div>
