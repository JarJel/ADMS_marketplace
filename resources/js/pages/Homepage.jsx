        ...
        <div className="min-h-screen bg-slate-100 dark:bg-[#071922] text-slate-900 dark:text-white font-sans transition-colors duration-300">
            ...
            <ScrollFadeIn>
                <section className="py-16 transition-colors duration-300 relative overflow-hidden bg-[#0F3040] dark:bg-[#071922] text-white border-b-2 border-[#174256]">
                                    ...
                                    <div className="flex items-center justify-center gap-2 mt-5">
                                        {promoSlides.map((_, idx) => (
                                            <button
                                                ...
                                                className={`transition-all duration-300 rounded-full ${idx === currentPromoSlide
                    ...
                    {/* Social Stats footer */}
                    <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        {/* Card 1 */}
                        <div className="group p-8 border border-[#174256] bg-gradient-to-b from-[#0F3040]/90 to-[#071922]/90 backdrop-blur-xl rounded-3xl shadow-2xl hover:shadow-[#FFBF00]/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative flex flex-col items-center text-center">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFBF00]/5 rounded-full blur-[50px] group-hover:bg-[#FFBF00]/10 transition-colors duration-500"></div>
                            <div className="w-16 h-16 rounded-2xl bg-[#071922] border border-[#174256] group-hover:border-[#FFBF00]/50 flex items-center justify-center mb-6 shadow-inner transition-all duration-500 group-hover:scale-110">
                                <Megaphone className="w-8 h-8 text-[#FFBF00] opacity-80 group-hover:opacity-100 transition-all duration-500" strokeWidth={1.5} />
                            </div>
                            <span className="block text-4xl sm:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-[#FFBF00] mb-2 tracking-tight drop-shadow-sm">
                                {platformStats ? `${platformStats.activeAds.toLocaleString('id-ID')}` : '...'}
                            </span>
                            <span className="text-xs sm:text-sm text-slate-400 group-hover:text-slate-200 uppercase font-bold tracking-widest transition-colors duration-300">
                                Iklan Baris Aktif
                            </span>
                        </div>

                        {/* Card 2 */}
                        <div className="group p-8 border border-[#174256] bg-gradient-to-b from-[#0F3040]/90 to-[#071922]/90 backdrop-blur-xl rounded-3xl shadow-2xl hover:shadow-[#FFBF00]/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative flex flex-col items-center text-center sm:mt-8">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFBF00]/5 rounded-full blur-[50px] group-hover:bg-[#FFBF00]/10 transition-colors duration-500"></div>
                            <div className="w-16 h-16 rounded-2xl bg-[#071922] border border-[#174256] group-hover:border-[#FFBF00]/50 flex items-center justify-center mb-6 shadow-inner transition-all duration-500 group-hover:scale-110">
                                <Shield className="w-8 h-8 text-[#FFBF00] opacity-80 group-hover:opacity-100 transition-all duration-500" strokeWidth={1.5} />
                            </div>
                            <span className="block text-4xl sm:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-[#FFBF00] via-[#ffcd33] to-white mb-2 tracking-tight drop-shadow-sm">
                        ...
                        <div className="group p-8 border border-[#174256] bg-gradient-to-b from-[#0F3040]/90 to-[#071922]/90 backdrop-blur-xl rounded-3xl shadow-2xl hover:shadow-[#FFBF00]/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden relative flex flex-col items-center text-center">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFBF00]/5 rounded-full blur-[50px] group-hover:bg-[#FFBF00]/10 transition-colors duration-500"></div>
                            <div className="w-16 h-16 rounded-2xl bg-[#071922] border border-[#174256] group-hover:border-[#FFBF00]/50 flex items-center justify-center mb-6 shadow-inner transition-all duration-500 group-hover:scale-110">
                                <Users className="w-8 h-8 text-[#FFBF00] opacity-80 group-hover:opacity-100 transition-all duration-500" strokeWidth={1.5} />
                            </div>
                            <span className="block text-4xl sm:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-white mb-2 tracking-tight drop-shadow-sm">
                                {platformStats ? `${platformStats.totalUsers.toLocaleString('id-ID')}` : '...'}
                            </span>
                            <span className="text-xs sm:text-sm text-slate-400 group-hover:text-slate-200 uppercase font-bold tracking-widest transition-colors duration-300">
                                Pengguna & Merchant Aktif
                            </span>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="flex justify-center mb-16">
                            <div className="inline-flex bg-white dark:bg-[#0F3040] border-2 border-slate-300 dark:border-[#174256] p-1.5 rounded-2xl gap-1 shadow-md">
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-5 py-2.5 rounded-xl text-xs font-black transition-all cursor-pointer ${activeTab === 'buyer'
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-5 py-2.5 rounded-xl text-xs font-black transition-all cursor-pointer ${activeTab === 'merchant'
                                        ? 'bg-[#FFBF00] text-[#0F3040] shadow-md'
                                        : 'text-slate-600 dark:text-slate-300 hover:text-[#0F3040] dark:hover:text-[#FFBF00]'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-5 py-2.5 rounded-xl text-xs font-black transition-all cursor-pointer ${activeTab === 'advertiser'
                                        ? 'bg-[#FFBF00] text-[#0F3040] shadow-md'
                                        : 'text-slate-600 dark:text-slate-300 hover:text-[#0F3040] dark:hover:text-[#FFBF00]'
                                        }`}
                                >
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <span>{faq.q}</span>
                                            <ChevronDown
                                                className={`w-4 h-4 text-[#FFBF00] flex-shrink-0 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''
                                                    }`}
                                            />
                                        </button>

                                        <div
                                            className={`transition-all duration-200 ease-in-out overflow-hidden ${isOpen ? 'max-h-40 border-t border-slate-200 dark:border-[#174256]' : 'max-h-0'
                                                }`}
                                        >
            ...
            <footer className={`pt-20 pb-10 border-t transition-colors ${darkMode ? 'bg-[#071324] text-slate-100 border-slate-900' : 'bg-white text-slate-800 border-slate-200'
                }`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                        ...
                        <div className="md:col-span-5 space-y-6">
                            ...
                            <div className="flex items-center gap-3">
                                {/* Instagram */}
                                <a href="https://www.instagram.com/adms.group?igsh=MWVtdWZ6NGF5NWI2Ng==" target="_blank" rel="noopener noreferrer" className={`w-8 h-8 rounded-lg border flex items-center justify-center transition-colors ${darkMode ? 'border-slate-800 text-slate-400 hover:text-white hover:border-slate-700' : 'border-slate-200 text-slate-500 hover:text-teal-600 hover:border-teal-500'
                                    }`}>
                                ...
                                {/* Email */}
                                <a href="mailto:Info@armadadigitalmarketing.top" className={`w-8 h-8 rounded-lg border flex items-center justify-center transition-colors ${darkMode ? 'border-slate-800 text-slate-400 hover:text-white hover:border-slate-700' : 'border-slate-200 text-slate-500 hover:text-teal-600 hover:border-teal-500'
                                    }`}>
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                                ...
                                {/* WhatsApp */}
                                <a href="https://wa.me/6281121211933" target="_blank" rel="noopener noreferrer" className={`w-8 h-8 rounded-lg border flex items-center justify-center transition-colors ${darkMode ? 'border-slate-800 text-slate-400 hover:text-white hover:border-slate-700' : 'border-slate-200 text-slate-500 hover:text-teal-600 hover:border-teal-500'
                                    }`}>
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
